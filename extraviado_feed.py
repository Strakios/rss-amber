...
ROOT_URL = BASE_URL + "/servicio-social/Extraviado"
RSS_FILENAME = "extraviado_feed.xml"
...
def generar_rss():
    fg = FeedGenerator()
    fg.title("Desaparecidos Quintana Roo")
    fg.link(href=ROOT_URL, rel='alternate')
    fg.description("RSS de personas desaparecidas (Extraviados) en Quintana Roo")
    fg.language("es")
