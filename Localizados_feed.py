...
ROOT_URL = BASE_URL + "/protocolo-alba-localizadas/alba"
RSS_FILENAME = "localizados_feed.xml"
...
def generar_rss():
    fg = FeedGenerator()
    fg.title("Localizados Alba Quintana Roo")
    fg.link(href=ROOT_URL, rel='alternate')
    fg.description("RSS de Protocolos Alba Localizados en Quintana Roo")
    fg.language("es")
